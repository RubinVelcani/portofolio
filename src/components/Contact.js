        ...
        <input type="hidden" name="form-name" value="rubin" />
          <div className='w-full max-w-screen-lg flex flex-col items-center bg-lightGray shadow-md text-xs text-gray mx-auto'>
            <div className='w-4/5 max-w-screen-sm flex flex-col text-left text-formGray mt-10 mb-16 mx-auto'>
              ...
              <input value={email} onChange={(e) => setEmail(e.target.value)} type='email' name='email' className='  ring-1 ring-gray-400 mb-8 py-4 px-4 outline-none focus-within:ring-blue-400' placeholder='Email' />
              ...
              <textarea value={message} onChange={(e) => setMessage(e.target.value)} name='message' className='  ring-1 ring-gray-400 mb-5 py-3 px-6 outline-none focus-within:ring-blue-400' placeholder='Your message...' />
              {messageErr && <h3 className='text-red-400 mb-10'>Please type a valid message</h3>}
              <div className='flex flex-row justify-around mt-10'>
                <button onClick={validateForm} className='w-1/2  bg-mainYellow text-black text-lg ring-1 ring-gray-400 mx-auto p-3 cursor-pointer outline-none focus-within:ring-blue-400 md:w-5/12'>Submit </button>
              </div>
            </div>
          </div>
        </form>

        ...
        <div>
          ...
          <div className='grid grid-cols-1'>
            <div className='mb-5'>
              ...
              <div className="mt-2 bg-black rounded-full">
                <div className="w-11/12 mt-2 bg-mainYellow py-1 rounded-full"></div>
              </div>
            </div>
            <div className='mb-5'>
              <h1 className='font-semibold'>Javascript</h1>
              <div className="mt-2 bg-black rounded-full">
                <div className="w-2/3 mt-2 bg-mainYellow py-1 rounded-full"></div>
              </div>
            </div>
            <div className='mb-5'>
              <h1 className='font-semibold'>ReactJS</h1>
              <div className="mt-2 bg-black rounded-full">
                <div className="w-9/12 mt-2 bg-mainYellow py-1 rounded-full"></div>
              </div>
            </div>
            <div className='mb-5'>
              <h1 className='font-semibold'>Wordpress</h1>
              <div className="mt-2 bg-black rounded-full">
                <div className="w-1/2 mt-2 bg-mainYellow py-1 rounded-full"></div>
              </div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div className='grid grid-cols-1'>
            <div className='mb-5'>
              ...
              <div className="mt-2 bg-black rounded-full">
                <div className="w-10/12 mt-2 bg-mainYellow py-1 rounded-full"></div>
              </div>
            </div>
            <div className='mb-5'>
              <h1 className='font-semibold'>Continuous Improvement</h1>
              <div className="mt-2 bg-black rounded-full">
                <div className="w-full mt-2 bg-mainYellow py-1 rounded-full"></div>
              </div>
            </div>
            <div className='mb-5'>
